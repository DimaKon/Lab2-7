<?php
	...
	$sql = "SELECT MAX(`themes`.`ThemID`) AS TID FROM `themes`";
	$result = mysql_Query($sql, $link);
	...
	{
		$sql = "INSERT INTO `themes` (`ThemID`, `ThemUID`, `ThemDate`, `ThemContent`, `ThemFID`, `ThemDescr`) VALUES (".$ThemID.", ".$UID.", '".$ThemDate."', '".$TContent."', ".$FID.", '')";
		$result = mysql_Query($sql, $link);
	};
	if (!$result)
	{
